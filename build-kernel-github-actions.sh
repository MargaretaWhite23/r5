...
build_badvpn() {
  ...
  cp /usr/local/share/man/man7/badvpn.7 /github/workspace/
  cp /usr/local/bin/badvpn-tun2socks /github/workspace/
  cp /usr/local/share/man/man8/badvpn-tun2socks.8 /github/workspace/
  cp /usr/local/bin/badvpn-udpgw /github/workspace/
